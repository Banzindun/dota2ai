...
/**
 * Class that represents sniper's ability to cast a shrapnel. Shrapnel is cast
 * to center of mass of enemy forces.
 * 
 * @author kocur
 *
 */
public class CastShrapnel extends Decision {

	private static final Logger logger = LogManager.getLogger(CastShrapnel.class);
	...
	public AgentCommand execute() {
		...
		// Log it.
		logger.info("Casting a shrapnel");
