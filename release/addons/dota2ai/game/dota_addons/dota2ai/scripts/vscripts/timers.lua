-- 
-- This is a timers library, that lets the game create and call custom think functions, that will respect the game pause. 
-- 
-- SOURCE: https://github.com/SteamDatabase/GameTracking-Dota2/blob/master/game/dota_addons/frostivus_2017/scripts/vscripts/libraries/timers.lua
