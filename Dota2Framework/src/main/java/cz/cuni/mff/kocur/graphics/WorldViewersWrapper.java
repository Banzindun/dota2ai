...
public class WorldViewersWrapper extends JPanel implements FrameworkEventListener, ActionListener {
	...
	/**
	 * Constructor of the world viewer.
	 */
	...
	private void updateTeamWorldViewer(int team) {
		...
		// Get the world
		World world = ControllersManager.getInstance().getTeamContext(team).getWorld();
	...
	private void updateAgentWorldViewer(String agentName) {
		...
		// Get the world ..
		ControllerWrapper wrapper = ControllersManager.getInstance().getControllerWrapperWithName(agentName);
