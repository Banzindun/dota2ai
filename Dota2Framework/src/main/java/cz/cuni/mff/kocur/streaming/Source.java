...
public interface Source {
	...
	/**
	 * Should return unique identification of this source. So that sink knows where the data come from.
	...
	/**
	 * Source name might not be unique and should be used as string that can be read by user, so that 
	 * he knows what is this source streaming etc.
