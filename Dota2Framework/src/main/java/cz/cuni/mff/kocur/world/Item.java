...
public class Item {
	...
	/**
	 * 
	 * @param shopType Sets shop type for this item.
	 */
	...
	/**
	 * 
	 * @return Returns ArrayList of items, that are needed to complete this one. The ArrayList can be empty, if this item is not composed out of many items.
	 */
	...
	/**
	 * 
	 * @param components New components to be stored inside this item.
	 */
	 ...
	 * @param comp Component of this item.
	 */
	...
	/**
	 * 
	 * @param s Shop, where I want to buy this item.
