...
public class AgentContext {
	...
	/**
	 * 
	 * @param configValue Name of the new lane.
	 */
	...
	/**
	 * 
	 * @param name Sets a new hero name.
	 */
	 ...
	 * @param str String that contains roles of this agent. [ESCAPE, CARRY]
	 */
	 ...
	 * @param teamContext New team context.
	 */
