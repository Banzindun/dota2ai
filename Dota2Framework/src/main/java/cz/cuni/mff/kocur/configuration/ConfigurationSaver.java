...
/**
 * This is class that should save the supplied configuration to file, that is
 * stored on supplied path.
 * 
 * @author kocur
 *
 */
public class ConfigurationSaver {
	 ...
	 * @throws ConfigurationSavingError
	 *             Thrown when the output stream couldn't be saved.
	 */
	 ...
	 * @param path
	 *            Path where should we save it.
	 * @throws ConfigurationSavingError
	 *             Thrown when there was an error during saving.
	 */
