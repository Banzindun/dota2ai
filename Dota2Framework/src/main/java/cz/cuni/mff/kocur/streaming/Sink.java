...
/**
 * Sink represents a place, where flows all the information from the sources.
 * Here we catch everything and then redistribute it to information catchers.
 * 
 * @author kocur
 *
 */
public class Sink {
	 ...
	 */
	private static Logger logger = LogManager.getLogger(Sink.class);
	...
	/**
	 * True if there was a change in catchers (added or removed one). If there is
	 * someone who works with this information he should flip this back.
	 */
	private static boolean catchersChanged = false;

	/**
	 * Drains the water coming from source with supplied id. This should be called
	 * from source's flow method. So that the information doesn't leak.
	 * 
	 * @param d
	 *            Drop of information.
	 */
	...
	/**
	 * 
	 * @return Returns array of ids of sources.
	 */
	...
	/**
	 * 
	 * @return Returns true, if the catchers changed (new added or one removed).
	 */
	...
	/**
	 * Sets catchers changed.
	 * 
	 * @param catchersChanged
	 *            True if they changed, false otherwise.
	 */
