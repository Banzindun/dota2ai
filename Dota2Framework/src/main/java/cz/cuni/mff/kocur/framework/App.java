...
/**
 * Class that represents the "main" of this application. It has a few states:
 * SETUP, CONFIGURATION, INIT, RUNNING etc., that correspond to the state of the
 * execution. There are some functions as start(), debug(), stopServer() etc.,
 * that control the application. Theese functions are called from server methods
 * and from buttons on main window.
 * 
...
public class App implements Controllable {
	 ...
	 * 
	 * @param args
	 *            Array of strings, that represents command line arguments.
	 */
	 ...
	 * sent and loaded. That means that I am ready to initialize the bots and go to
	 * RUNNING state
	 * 
	 */
	 ...
	 * 
	 * @param arguments
	 *            New command line arguments to store.
	 */
