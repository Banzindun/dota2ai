...
public abstract class Brain {
	 ...
	 */
	protected ExtendedBotContext botContext = null;
	 ...
	 *            thinking.
	 */
	public Brain(ExtendedBotContext botContext) {
	 ...
	 * @param s Set to add to this brain.
	 */
	 ...
	 * @param s Void decision set, that should be added to this brain.
	 */
	 ...
	 * @param other Other brain, from which we copy.
	 */
	...
	/**
	 * 
	 * @param voidDecisionSets New list of void decisions.
	 */
	...
	/**
	 * 
	 * @param decisionSets Sets a new decision set.
	 */
