...
/**
 * Class that represents a hero's ability. Ability is a BaseEntity too, but is
 * destroyed and lives with the hero.
 * 
 * @author kocur
 *
 */
public class Ability extends BaseEntity {
	...
	public String toString() {
		...
		builder.appendLines("targetFlags:" + targetFlags, "targetTeam:" + targetTeam, "targetType:" + targetType,
				"abilityType:" + abilityType, "abilityIndex:" + abilityIndex, "level:" + level, "maxLevel:" + maxLevel,
				"abilityDamage:" + abilityDamage, "abilityDamageType:" + abilityDamageType, "behavior:" + behavior,
				"cooldownTime:" + cooldownTime, "cooldownTimeRemaining:" + cooldownTimeRemaining,
				"origin: " + x + ", " + y + ", " + z, "name:" + name, "health: " + health, "maxHealth:" + maxHealth,
				"castRange" + castRange);
