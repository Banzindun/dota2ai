...
/**
 * Class that stores all the in-game items.
 * 
 * @author kocur
 *
 */
public class ItemsBase {
	 ...
	 *            Price of the item.
	 * @param type
	 *            Type of the shop, that buys this item.
	 *            {@link cz.cuni.mff.kocur.interests.Shop}
	 */
	...
	/**
	 * Loads item's components. This function will not throw if item or its
	 * component weren't found. The item base is quite big and one item without
	 * component is not a problem that would break the framework (it just needs to
	 * be logged and solved later).
	 * 
	 * @param name
	 *            Name of the item.
	 * @param components
	 ...
	 * @param name
	 *            Name of the item.
	 * @return Returns item with given name or null if the item doesn't exist inside
	 *         the base.
	 */
