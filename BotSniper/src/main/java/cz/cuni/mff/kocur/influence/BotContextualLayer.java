...
public abstract class BotContextualLayer extends InfluenceLayer {
	/**
	 * Logger for LinaThreatLayer.
	 */
	private final static Logger logger = LogManager.getLogger(BotContextualLayer.class.getName());

	/**
	 * ...
	 */
	public static int VISON_ENHANCEMENT = 20;
	...
	public BotContextualLayer(GridSystem parentGS, AgentContext ctx) {
		super(1, 1, 1);
	 ...
	 */
	public BotContextualLayer(BotContextualLayer c) {
		super(c);
