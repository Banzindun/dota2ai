...
public class EnemyHeroInfluence extends WavePropagationWithContext<Hero> {
	 ...
	 */
	private static final Logger logger = LogManager.getLogger(EnemyHeroInfluence.class);
	...
	public void propagate(InfluenceLayer l, Hero e) {
		...
		// Base can be null if we are working with neutral creeps, else set max and min distance
		if (base != null) {
