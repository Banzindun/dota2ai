...
/**
 * Abstract configuration. Adds some basic methods for retrieving configuration
 * values etc.
 * 
 * @author kocur
 *
...
public abstract class Configuration {
	...
	/**
	 * Map that stores pairs that are specified in JSON file as pairs "name" :
	 * "value".
	 */
	...
	/**
	 * List of ConfigurationChangeListener that listen for change of the
	 * configuration. They will be alerted after the {@link #onChange()} method is
	 * called.
	 */
	@JsonIgnore
	...
	/**
	 * Removes the specified listener from waiting list of objects that are waiting
	 ...
	 * 
	 * @param items
	 *            Map with keys and values giving fields in shape "name": "value" in
	 *            JSON file.
	 * @param path
	 ...
	 * 
	 * @param name
	 *            name of the field which value we want to know
	...
	/**
	 * Method for classes that implement configuration fields. This method should
	 * return the value associated with given field name.
	 * 
	 * @param name
	 *            Name of the field whose value you want to retrive.
	 ...
	 *            Name of the item.
	 * @param value
	 *            The item that should be stored.
	 */
	 ...
	 * @throws ConfigurationTestFailureException If test failed.
	 */
	public void test() throws ConfigurationTestFailureException {
		...
		if (items == null) {
			ConfigurationTestFailureException ex = new ConfigurationTestFailureException(
					"Items that were set to this configuration are null.");
			throw ex;
		}
	}
