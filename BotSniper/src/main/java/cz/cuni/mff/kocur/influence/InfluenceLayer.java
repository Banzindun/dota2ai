...
public abstract class InfluenceLayer extends GridSystem {
	...
	/**
	 * Checks if first supplied array is g than or equal to second array. Meaning
	 * first[0] <= second[0] && first[1] <= second[1].
	 * 
	 * @param ds
	 * @param ds2
	 * @return True if first array is less or equal than second array.
	 */
	private boolean isLessOrEqual(double[] ds, double[] ds2) {
	...
	/**
	 * Multiplies this layer by the layer passed in arguments, if possible.</br>
	 * During each multiplication, the value is multiplied by passed multiplier.
	 * 
	 * @param l
	 ...
	 * directory with specified fileName. </br>
	 * The location will be specified inside logs, so consult them if you don't know
