...
/**
 * This class setups the application. </br>
 * It loads important directoris and paths (workingDirectory, outputDirectory
 * ..) and checks, that necessary files are there (grid.data, items.data), if
 * they are not the user should be alerted and application should end. </br>
 * 
...
public class Setup {
	...
	public static void setup(App app) throws SetupException {
		...
		Setup.setDota2aiBotsDirectory(path(dota2Path, "game", "dota_addons", "dota2ai", "scripts", "vscripts", "bots", ""));
	 ...
	 * @throws SetupException Thrown if something went wrong while moving the files.
	 */
